...
def augment_and_transform_batch(examples, transform, image_processor, class_map, return_pixel_mask=False):
...
def finetuning(args):
    ...
    train_transform_batch = partial(
        augment_and_transform_batch, transform=train_augment_and_transform, image_processor=image_processor, class_map=data2model
    )

    validation_transform_batch = partial(
        augment_and_transform_batch, transform=validation_transform, image_processor=image_processor, class_map=data2model
    )
