...
def main(args):
    ...
    control_dataset = KittiDatasetTorchvision(
        args.dataset, args.annotation_folder, args.image_folder, args.seqmap
    )
    ...
    for transform, prefix in tqdm(transforms):
        ...
        dataset = KittiDatasetTorchvision(
            args.dataset,
        ...
        for i in range(args.num_samples):
            ...
            augmented_annotated = draw_bbox(
                augmented_img, augmented_bboxes, id2label, scores_key="area"
            )
