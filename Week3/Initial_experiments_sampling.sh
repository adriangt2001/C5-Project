...
RUNS_DIR="${RUNS_DIR:-$PROJECT_DIR/runs/initial_experiments_sampling}"
...
TRAINABLE_BACKBONE="${TRAINABLE_qBACKBONE:-0}"
SCHEDULED_SAMPLING_MAX_RATIO="${SCHEDULED_SAMPLING_MAX_RATIO:-0.4}"
